...
export class DouyinUserEntity {
    ...
    @ApiProperty({ description: 'The user_id of the douyin User' })
    @OneToOne(() => UserEntity, user => user.douyinUser) // 将另一面指定为第二个参数
	...
	constructor(partial: Partial<DouyinUserEntity>) {
		/*if (partial) {
